//#region src/wasm/arcjet_analyze_js_req.component.js
	...
	let gen = (function* init() {
		...
		function trampoline1(arg0, arg1, arg2, arg3) {
			...
			switch (val2) {
				...
				case "unverifiable":
					...
					break;
				default:
					if (ret instanceof Error) console.error(ret);
		...
		function trampoline3(arg0, arg1, arg2) {
			...
			for (let i = 0; i < vec5.length; i++) {
				...
				var variant4 = e;
				if (variant4 === null || variant4 === void 0) dataView(memory0).setInt8(base + 0, 0, true);
				else {
					const e = variant4;
					...
					switch (variant3.tag) {
						...
						default: throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant3.tag)}\` (received \`${variant3}\`) specified for \`SensitiveInfoEntity\``);
					}
				}
			}
		...
		({exports: exports1} = yield instantiateCore(yield module0, {
			"arcjet:js-req/bot-identifier": { detect: exports0["0"] },
			...
			"arcjet:js-req/filter-overrides": { "ip-lookup": exports0["2"] },
			"arcjet:js-req/sensitive-information-identifier": { detect: exports0["3"] },
			"arcjet:js-req/verify-bot": { verify: exports0["1"] }
		}));
		...
		function detectBot(arg0, arg1) {
			...
			switch (variant7.tag) {
				case "allowed-bot-config":
					var { entities: v1_0, skipCustomDetect: v1_1 } = variant7.val;
					var vec3 = v1_0;
				...
				case "denied-bot-config":
					var { entities: v4_0, skipCustomDetect: v4_1 } = variant7.val;
					var vec6 = v4_0;
					...
					variant7_3 = v4_1 ? 1 : 0;
					break;
				default: throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant7.tag)}\` (received \`${variant7}\`) specified for \`BotConfig\``);
			}
			...
			switch (dataView(memory0).getUint8(ret + 0, true)) {
				...
				case 1:
					...
					variant15 = {
						tag: "err",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr14, len14))
					};
					break;
			...
			postReturn0(ret);
			if (typeof retVal === "object" && retVal.tag === "err") throw new ComponentError(retVal.val);
			return retVal.val;
		}
		function matchFilters(arg0, arg1, arg2, arg3) {
			...
			switch (dataView(memory0).getUint8(ret + 0, true)) {
				...
				case 1:
					...
					variant10 = {
						tag: "err",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr9, len9))
					};
					break;
				default: throw new TypeError("invalid variant discriminant for expected");
			}
		...
		function generateFingerprint(arg0, arg1) {
			...
			switch (dataView(memory0).getUint8(ret + 0, true)) {
				case 0:
					...
					variant5 = {
						tag: "ok",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr3, len3))
					};
					break;
				case 1:
					...
					variant5 = {
						tag: "err",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr4, len4))
					};
					break;
				default: throw new TypeError("invalid variant discriminant for expected");
			}
		...
		function isValidEmail(arg0, arg1) {
			...
			switch (variant7.tag) {
				case "allow-email-validation-config":
					var { requireTopLevelDomain: v1_0, allowDomainLiteral: v1_1, allow: v1_2 } = variant7.val;
					var vec3 = v1_2;
					var len3 = vec3.length;
					var result3 = realloc0(0, 0, 4, len3 * 8);
					for (let i = 0; i < vec3.length; i++) {
				...
				case "deny-email-validation-config":
					var { requireTopLevelDomain: v4_0, allowDomainLiteral: v4_1, deny: v4_2 } = variant7.val;
					var vec6 = v4_2;
					var len6 = vec6.length;
					var result6 = realloc0(0, 0, 4, len6 * 8);
					for (let i = 0; i < vec6.length; i++) {
					...
					variant7_4 = len6;
					break;
				default: throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant7.tag)}\` (received \`${variant7}\`) specified for \`EmailValidationConfig\``);
			}
			...
			switch (dataView(memory0).getUint8(ret + 0, true)) {
				case 0: {
					...
					switch (dataView(memory0).getUint8(ret + 4, true)) {
						...
						case 1:
							enum8 = "invalid";
							break;
						default: throw new TypeError("invalid discriminant specified for EmailValidity");
					}
				...
				case 1:
					...
					variant12 = {
						tag: "err",
						val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr11, len11))
					};
					break;
				default: throw new TypeError("invalid variant discriminant for expected");
			}
				...
				case "deny":
					...
					for (let i = 0; i < vec7.length; i++) {
						...
						switch (variant6.tag) {
							...
							default: throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant6.tag)}\` (received \`${variant6}\`) specified for \`SensitiveInfoEntity\``);
						}
					}
					variant8_0 = 1;
					variant8_1 = result7;
					variant8_2 = len7;
					break;
				default: throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant8.tag)}\` (received \`${variant8}\`) specified for \`SensitiveInfoEntities\``);
			}
			var variant9 = v1_1;
			let variant9_0;
			let variant9_1;
			...
			for (let i = 0; i < len12; i++) {
				...
				switch (dataView(memory0).getUint8(base + 8, true)) {
					case 0:
						...
						break;
					case 1:
						variant11 = { tag: "phone-number" };
						break;
					case 2:
						variant11 = { tag: "ip-address" };
						break;
					case 3:
						variant11 = { tag: "credit-card-number" };
						break;
					case 4:
						...
						variant11 = {
							tag: "custom",
							val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr10, len10))
						};
						break;
					default: throw new TypeError("invalid variant discriminant for SensitiveInfoEntity");
				}
				result12.push({
			...
			for (let i = 0; i < len15; i++) {
				...
				switch (dataView(memory0).getUint8(base + 8, true)) {
					case 0:
						...
						break;
					case 1:
						variant14 = { tag: "phone-number" };
						break;
					case 2:
						variant14 = { tag: "ip-address" };
						break;
					case 3:
						variant14 = { tag: "credit-card-number" };
						break;
					case 4:
						...
						variant14 = {
							tag: "custom",
							val: utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr13, len13))
						};
						break;
					default: throw new TypeError("invalid variant discriminant for SensitiveInfoEntity");
				}
